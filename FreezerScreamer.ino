...
void checkFreezerScreamerConditions() {
  ...
  if(fahrenheitTemp > highFahrenheitThreshhold1) {
    highThreshExceededCounter++;
    ...
    highThreshExceededCounter = 0;
  }

  if (fahrenheitTemp < lowFahrenheitThreshhold) {
    lowThreshExceededCounter++;
